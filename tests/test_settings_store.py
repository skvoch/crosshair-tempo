...
class SettingsStoreTests(unittest.TestCase):
    def test_round_trip_preserves_input_scope(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            save_settings(Settings(only_cs2_focused=True, crosshair_shape="cross", overlay_screen="\\\\.\\DISPLAY2", show_estimated_speed=True), path)
            ...
            self.assertTrue(restored.show_estimated_speed)
